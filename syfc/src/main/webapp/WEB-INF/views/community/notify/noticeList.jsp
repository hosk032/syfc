	...
	<table class="table table-hover board-list">
	    ...
	    <tbody>
			...
			<div class="row board-list-footer">
				<div class="col">
					<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/community/notify/noticeList';" title="새로고침"><i class="bi bi-arrow-counterclockwise"></i></button>
				</div>
...
function searchList() {
	...
	let url = '${pageContext.request.contextPath}/community/notify/noticeList';
