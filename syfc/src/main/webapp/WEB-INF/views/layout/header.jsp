...
<div class="header_top">
	<div
		...
		<!-- 좌측 로고 -->
		<div class="logo"
			onclick="location.href='${pageContext.request.contextPath}/';">쌍용축구예약</div>
		...
		<div class="header-icons">
			<c:choose>
				<c:when test="${sessionScope.member.userLevel >= 1}">
					<span id="noticeButtonWrapper" class="notice-button-wrapper">
						<i class="fa-regular fa-bell" id="noticeBtn" title="알림"></i> <span
						id="noticeBadge" class="notice-badge"></span>
					</span>
				</c:when>
				<c:otherwise>
					<i id="singupBtn" class="fa-regular fa-bell" title="로그인/회원가입"
						data-bs-toggle="modal" data-bs-target="#signupModal"></i>
				</c:otherwise>
			</c:choose>

			<c:choose>
				<c:when test="${sessionScope.member.userLevel < 50}">
					<i class="fa-regular fa-user" title="마이페이지"
			...
			<i class="fa-solid fa-right-from-bracket" title="로그아웃"
		...
		<nav class="main-nav">
			<div class="nav-container">
				<ul class="nav-menu" onclick="return false;">
					<li><a
						href="${pageContext.request.contextPath}/community/boardList"
						class="active">커뮤니티</a></li>
					<li><a
						href="${pageContext.request.contextPath}/community/stadium_info">경기장
							정보</a></li>
				...
				<div class="dropdown-panel">
					<div class="dropdown-column">
						<a
							href="${pageContext.request.contextPath}/community/notify/noticeList">공지사항</a>
						<a
							href="${pageContext.request.contextPath}/community/board/boardList">자유게시판</a>
						<a href="${pageContext.request.contextPath}/community/qna/qnaList">문의/신고</a>
					</div>
					<div class="dropdown-column">
						<a href="${pageContext.request.contextPath}/stadium/stadiumInfo">경기장
							정보 검색</a>
					</div>
					<div class="dropdown-column">
						<a
							href="${pageContext.request.contextPath}/clubmatch/clubCalendar">캘린더</a>
						<a
							href="${pageContext.request.contextPath}/clubmatch/clubMatchRank">최근
							기록</a> <a
							href="${pageContext.request.contextPath}/clubmatch/matchInfo">구단
							검색 (연도별 / 구단별)</a>
					</div>
					<div class="dropdown-column">
						<a href="${pageContext.request.contextPath}/clubinfoply/clubList">구단
							정보</a> <a
							href="${pageContext.request.contextPath}/clubinfoply/playerInfo">소속
							선수들의 정보</a> <a
							href="${pageContext.request.contextPath}/clubinfoply/playerList">선수
							정보</a>
					</div>
				</div>
			</div>
			...
			<c:choose>
				...
				<c:when test="${sessionScope.member.userLevel == 50}">
					<button class="tag-btn"
						onclick="location.href='${pageContext.request.contextPath}/clubowner/ownerpage';">
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/dist/css/main/modalNotice.css">
<script
	src="${pageContext.request.contextPath}/dist/js/main/modalNotice.js"></script>
