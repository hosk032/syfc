...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/player/clubOwnerRequest.css?v=20260822-summary-profile" />
</head>
<body>
		...
		<div class="row">
			...
			<div class="col-md-3 mb-4">
				<div class="list-group">
					...
					<a href="${pageContext.request.contextPath}/player/clubOwnerRequest" class="list-group-item list-group-item-action ps-4 active">구단주 신청</a> 
