...
<body>
    ...
    <div class="register-container my-4">
        ...
        <form action="${pageContext.request.contextPath}/member/join" method="POST" id="joinForm" enctype="multipart/form-data">
            ...
            <div class="form-section text-center">
                ...
                <input type="file" class="d-none" id="profileImageInput" name="profileImage" accept="image/*" onchange="previewProfileImage(this)">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="input-group full-width">
                        <label>선호 포지션 (pref_position : 1-GK / 2-DF / 3-MF / 4-FW)</label>
                        <div class="radio-group">
                            <div class="radio-option">
