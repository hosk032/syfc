...
<!-- 프로젝트 CSS -->
<link rel="stylesheet"
href="${pageContext.request.contextPath}/project/css/style.css">
...
<!-- 로그인 모달 -->
<div class="modal fade memberShip" id="singupModal" data-bs-backdrop="static" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <form class="mt-4">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control custom-input" id="loginId" placeholder="아이디">
                    <label for="loginId" class="text-muted">아이디</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="password" class="form-control custom-input" id="loginPwd" placeholder="비밀번호">
                    <label for="loginPwd" class="text-muted">비밀번호</label>
                </div>

                <div class="d-flex justify-content-between align-items-center mb-4 px-1">
                    <div class="form-check">
                        <input class="form-check-input custom-checkbox" type="checkbox" id="keepLogin">
                        <label class="form-check-label small text-muted cursor-pointer" for="keepLogin">
                            로그인 유지하기
                        </label>
                    </div>
                ...
                <button type="submit" class="btn btn-login-submit w-100 py-3 fw-bold mb-3">
                    로그인
                </button>
            </form>
            ...
            <div class="modal-footer-custom pt-3 border-top text-center">
                ...
                <button type="button" class="btn btn-link btn-signup-link p-0 ms-1 fw-bold text-decoration-none" onclick="location.href='${pageContext.request.contextPath}/member/register.do';">
                    회원가입하기
                </button>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/project/js/footer.js"></script>
